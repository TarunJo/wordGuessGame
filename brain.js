...
function start()
{
    ...
    if(chances==8)
    {
        hidden=wordList[Math.floor(Math.random() *wordList.length)].word;
        phrase=wordList[Math.floor(Math.random() *wordList.length)].hint;
    }
    if(chances==0)
    {
        // chances=8;
    ...
    for(let i=0;i<arr.length;i++){
        ...
        // else gussed+="-";
        // if(element.innertext!="") gussed+=element.innertext;
    }
    chances--;
    // console.log(gussed);
}